...
int sc_main(int ac, char *av[])
{
  ...
  //!  ISA simulator
  mips mips_proc1("mips"), mips_proc2("mips2");
...
#endif 
/*
  char *av1[] = {"dual_ppc.x", "--load=myprogs/dekkoh.mips", ""};
  int ac1 = 3;
  char *av2[] = {"dual_ppc.x", "--load=myprogs/dekkoh.mips", ""};
  int ac2 = 3;
*/
  int ac1 = ac;
  int ac2 = ac;
  ...
  char** av1 = av;
  char** av2 = (char**) malloc (ac1 * sizeof(char*));
  for(int i = 0; i<ac2; i++){
    av2[i] = (char*) malloc (strlen(av1[i]) * sizeof(char));
    strcpy(av2[i], av1[i]);
  }
